package com.specknet.airrespeck.qoeuploadservice
...
class QOERemoteUploadService {
    companion object {
        ...
        const val MSG_UPLOAD = "com.specknet.airrespeck.qoeuploadservice.MSG_UPLOAD"
        const val MSG_CONFIG = "com.specknet.airrespeck.qoeuploadservice.MSG_CONFIG"
        const val MSG_UPLOAD_DATA = "com.specknet.airrespeck.qoeuploadservice.live_data"
        const val MSG_CONFIG_JSON_HEADERS = "com.specknet.airrespeck.qoeuploadservice.config_headers"
        const val MSG_CONFIG_URL = "com.specknet.airrespeck.qoeuploadservice.config_url"
        const val MSG_CONFIG_PATH = "com.specknet.airrespeck.qoeuploadservice.config_path"
